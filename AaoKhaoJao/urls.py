...
urlpatterns = [
    ...
    url(r'^edit_menu/(?P<id>[0-9]+)$', views.manage_restaurants),
    ...
    url(r'^menu/create/(?P<pk>[0-9]+)/$', view=classviews.menucreateview.as_view(), name="addmenu"),
    ...
    url(r'^testing/$',views.restaurant_menu)
]